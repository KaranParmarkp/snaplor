...
class SocialService extends ApiService {
  ...
  Future<Response<GenericResponse>> commentPost(String id,String message,String? commentID) async {
    return putData(ApiConfig.addPost+"/"+id+"/comments",data: {"comment":message});
  }
